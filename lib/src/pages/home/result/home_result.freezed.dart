...
mixin _$HomeResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String mensage) error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(List<T> data)? success,
    TResult Function(String mensage)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'HomeResult<$T>.error(mensage: $mensage)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$Error<T> &&
            const DeepCollectionEquality().equals(other.mensage, mensage));
  }

  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(mensage));
...
abstract class Error<T> implements HomeResult<T> {
  factory Error(final String mensage) = _$Error<T>;
